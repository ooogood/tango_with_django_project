...
# chapter 6
	...
	# return render(request, 'rango/index.html', context=context_dict)
# chapter 10: to test if your browser accept cookie
...
# chapter 9
# this class is just like another add_user page
...
# chapter 10
# # method 1: store cookies in request and response.
...
# # method 2: store session in request and response, and use session to get cookie from server.
# A helper method
